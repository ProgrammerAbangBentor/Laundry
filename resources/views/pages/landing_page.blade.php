...
<head>
    ...
    <link href="{{ asset('landing_page/lib/tempusdominus/css/tempusdominus-bootstrap-4.min.css') }}" rel="stylesheet" />
...
<body>
    ...
    <script src="{{ asset('landing_page/lib/tempusdominus/js/moment.min.js') }}"></script>
    <script src="{{ asset('landing_page/lib/tempusdominus/js/moment-timezone.min.js') }}"></script>
    <script src="{{ asset('landing_page/lib/tempusdominus/js/tempusdominus-bootstrap-4.min.js') }}"></script>
